import { func, date, url } from '@/components/uvui/uv-ui-tools/libs/function/test.js'
import { error, timeFormat, priceFormat } from '@/components/uvui/uv-ui-tools/libs/function/index.js'
export default {
    computed: {
        // 经处理后需要显示的值
        value() {
