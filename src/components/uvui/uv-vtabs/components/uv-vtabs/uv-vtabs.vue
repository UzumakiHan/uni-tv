...
<script>
	import mpMixin from '@/components/uvui/uv-ui-tools/libs/mixin/mpMixin.js'
	import mixin from '@/components/uvui/uv-ui-tools/libs/mixin/mixin.js'
	import debounce from '@/components/uvui/uv-ui-tools/libs/function/debounce.js'
	import throttle from '@/components/uvui/uv-ui-tools/libs/function/throttle.js'
	import uvBadgeProps from '@/components/uvui/uv-badge/components/uv-badge/props.js'
	import uvBadge from '@/components/uvui/uv-badge/components/uv-badge/uv-badge.vue'
...
<style scoped lang="scss">
	@import '@/components/uvui/uv-ui-tools/libs/css/components.scss';
	@import '@/components/uvui/uv-ui-tools/libs/css/color.scss';
	.uv-vtabs {
		@include flex;
		&__bar {
