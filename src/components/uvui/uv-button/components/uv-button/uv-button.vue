...
import button from '@/components/uvui/uv-ui-tools/libs/mixin/button.js'
import openType from '@/components/uvui/uv-ui-tools/libs/mixin/openType.js'
...
$show-reset-button: 1;
@import '@/components/uvui/uv-ui-tools/libs/css/variable.scss';
