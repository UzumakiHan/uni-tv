...
<script>
	...
	import uvStatusBar from '@/components/uvui/uv-status-bar/components/uv-status-bar/uv-status-bar.vue'
	import uvTransition from '@/components/uvui/uv-transition/components/uv-transition/uv-transition.vue'
	import uvSafeBottom from '@/components/uvui/uv-safe-bottom/components/uv-safe-bottom/uv-safe-bottom.vue'
	import uvIcon from '@/components/uvui/uv-icon/components/uv-icon/uv-icon.vue'
	/**
	* PopUp 弹出层
